...
reactivepower <- as.numeric(date_data$Global_reactive_power)
voltage <- as.numeric(date_data$Voltage)
submeter1 <- as.numeric(date_data$Sub_metering_1)
submeter2 <- as.numeric(date_data$Sub_metering_2)
submeter3 <- as.numeric(date_data$Sub_metering_3)
